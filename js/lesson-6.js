        ...
        this._render ()
         ...
         document.querySelector (this.container).addEventListener ('click', (evt) => {
             if (evt.target.classList.contains ('buy-btn')) {                                  
                 ...
                 document.getElementById('cart').innerHTML = `Куплен товар ${product.name}, по цене ${+product.price}$`                                  
            }
         })
    },
    _fetchItems () {
...
let newTextBlock = document.getElementsByClassName('desc')
newTextBlock[0].style.paddingLift = '25px'
